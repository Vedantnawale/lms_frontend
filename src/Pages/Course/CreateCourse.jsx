...
const CreateCourse = () => {
  ...
  async function onFormSubmit(e) {
    e.preventDefault();  // form ka default behaviour hai ki sumbit karne ke baad refresh karega.
    ...
    <HomeLayout>
      <div className='flex items-center justify-center h-[100vh]'>
        <form
          ...
          className='flex flex-xol justify-center gap-5 rounded-lg p-4 text-white w-[700px] my-10 shadow-[0_0_10px_black] relative'
        >
          ...
          <button
          type="sumbit"
          // onSubmit={onFormSubmit} he check karne
